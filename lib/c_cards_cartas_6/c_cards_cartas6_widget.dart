...
class CCardsCartas6Widget extends StatefulWidget {
  const CCardsCartas6Widget({Key? key}) : super(key: key);

  @override
  _CCardsCartas6WidgetState createState() => _CCardsCartas6WidgetState();
}

class _CCardsCartas6WidgetState extends State<CCardsCartas6Widget> {
                ...
                Row(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        'Proíbido dizer calão ou ofensas',
                        textAlign: TextAlign.center,
                        style: FlutterFlowTheme.of(context).bodyText1.override(
                              fontFamily: 'Poppins',
                              color: Color(0xFFF6B100),
